...
- **UI Enhancements**: USDA foods display unit selector dropdown, catalog foods show locked native unit. Real-time macro preview updates as users adjust serving size. Volume-based units (cups/tbsp) marked as "(approx)".
