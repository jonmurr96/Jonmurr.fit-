-- Simple Workout Tracking Setup
-- Copy and run this ENTIRE file at once
...
-- Helper function: Get previous workout sets
...
-- Helper function: Complete workout session
...
-- Success message
SELECT '✅ Workout tracking setup complete!' AS status;
